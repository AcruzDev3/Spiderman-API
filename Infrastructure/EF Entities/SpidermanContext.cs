...
public partial class SpidermanContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CrimeEntity>(entity =>
        {
        ...
        modelBuilder.Entity<CrimeGradeEntity>(entity =>
        {
        ...
        modelBuilder.Entity<CrimeTypeEntity>(entity =>
        {
        ...
        modelBuilder.Entity<CriminalEntity>(entity =>
        {
